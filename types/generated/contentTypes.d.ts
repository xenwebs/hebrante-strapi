...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    shippingStatus: Schema.Attribute.Enumeration<
      ['awaiting_shipment', 'label_created']
    > &
      Schema.Attribute.DefaultTo<'awaiting_shipment'>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    feature1_en: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    feature2_en: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    feature3_en: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    fitCoefficients: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::product.product'
    >;
    materials: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    materials_en: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    onesize: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    stock_by_size: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiWorkshopPageWorkshopPage
  extends Struct.CollectionTypeSchema {
  collectionName: 'workshop_pages';
  info: {
    displayName: 'workshop page';
    pluralName: 'workshop-pages';
    singularName: 'workshop-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::workshop-page.workshop-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
